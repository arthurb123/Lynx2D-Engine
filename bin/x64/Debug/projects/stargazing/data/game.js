lx.Initialize('stargazing'); lx.Smoothing(false); lx.Start(60);var Scene0 = new lx.Scene(function() {var StarSprite = new lx.Sprite('res/lynx2d/particle.png'); lx.ParticleLimit(1200);
...
var stars = [];
for (var i = 0; i < 1200; i++) stars[i] = new Star();
