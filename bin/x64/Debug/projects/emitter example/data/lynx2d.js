...
function Lynx2D() {
    ...
    this.GAME = {
        ...
        INIT: function(FPS) {
            ...
            console.log(lx.GAME.LOG.TIMEFORMAT() + 'Started game loop at ' + this.SETTINGS.FPS + ' FPS!');
        },
        LOG: {
            DATE: 0,
            DATA: {
        ...
        TRANSLATE_FROM_FOCUS: function(POS) {
            if (this.FOCUS == undefined) return POS;
                ...
                X: POS.X-this.FOCUS.Position().X+lx.GetDimensions().width/2-this.FOCUS.Size().W/2,
                Y: POS.Y-this.FOCUS.Position().Y+lx.GetDimensions().height/2-this.FOCUS.Size().H/2
            };
        },
    ...
    this.Initialize = function(title) {
        ...
        document.body.append(this.CONTEXT.CANVAS);
    ...
    this.CreateController = function() {
        ...
        document.addEventListener('mousedown', function(EVENT) { if (lx.CONTEXT.CONTROLLER.MOUSE.STOPPED_BUTTONS[EVENT.button]) return; lx.CONTEXT.CONTROLLER.MOUSE.BUTTONS[EVENT.button] = true; });
