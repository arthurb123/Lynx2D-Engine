lx.Initialize('jungle example'); lx.Smoothing(false); lx.Start(60);document.getElementById('icon').href='res/favicon.ico';var Sprite0 = new lx.Sprite('res/player.png');Sprite0.Clip(0, 0, 64, 64);var Sprite3 = new lx.Sprite('res/player.png');Sprite3.Clip(0, 0, 64, 64);var PlayerSpriteReverse = new lx.Sprite('res/player_reverse.png');PlayerSpriteReverse.Clip(0, 0, 64, 64);var WorldTile = new lx.Sprite('res/world.png');WorldTile.Clip(24, 24, 32, 32);var WorldCollider1 = new lx.Collider(-250, -50, 64, 200, true, function(data) {if (!data.static) 
