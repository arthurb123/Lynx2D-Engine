...
var HouseCollider = new lx.Collider(0, -300, 260, 200, true, function(data) {});HouseCollider.Solid(true); HouseCollider.Enable(); var PlayerCollider = new lx.Collider(6, 8, 36, 40, false, function(data) {});PlayerCollider.Solid(true); PlayerCollider.Enable(); var PropCollider = new lx.Collider(18, 18, 24, 32, false, function(data) {});PropCollider.Solid(true); PropCollider.Enable(); var FireCollider = new lx.Collider(18, 152, 32, 26, true, function(data) {if (lx.FindGameObjectWithCollider(data.trigger).Identifier() == "Player")
	Player.AddVelocity(
		Player.Movement().VX*-3,
		Player.Movement().VY*-3
				);});FireCollider.Solid(true); FireCollider.Enable(); var StoneCollider = new lx.Collider(142, 8, 42, 36, false, function(data) {});StoneCollider.Solid(true); StoneCollider.Enable(); var Prop2Collider = new lx.Collider(18, 18, 24, 32, false, function(data) {});Prop2Collider.Solid(true); Prop2Collider.Enable(); var Player = new lx.GameObject(PlayerSprite, -60, 30, 48, 48); Player.ApplyCollider(PlayerCollider); Player.Show(3); var Prop = new lx.GameObject(Chair, -60, 120, 64, 64); Prop.ApplyCollider(PropCollider); Prop.Show(2); var Prop2 = new lx.GameObject(Chair, 64, 164, 64, 64); Prop2.ApplyCollider(Prop2Collider); Prop2.Show(2); var FireEmitter = new lx.Emitter(Sprite24, 24, 152, 18, 30); FireEmitter.Setup(0, 0, -1, 0, 12, 22); FireEmitter.Speed(8); FireEmitter.Show(3); Player.Focus();
